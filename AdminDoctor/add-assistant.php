        ...
        <form id="assistantForm" class="modern-form">
                ...
                <div class="form-section-header">
                    <div class="section-icon">
                        <svg viewBox="0 0 24 24" width="24" height="24">
                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>ircle cx="12" cy="7" r="4"/>
                        </svg>
                    </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary btn-large" id="submitBtn">
                    <svg viewBox="0 0 24 24" width="20" height="20">
                        <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/>ircle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>
                    </svg>
                    Add Assistant
                </button>
