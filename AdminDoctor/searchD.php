...
<head>
  ...
  <title>Doctor List - MedOffice</title>
...
<body>
  ...
  <div id="archiveModal" class="modal">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure you want to archive this doctor? This action will move the doctor record to the archive section.</p>
        <div class="modal-info">
          <p><strong>Doctor ID:</strong> <span id="archive-doctor-id"></span></p>
          <p><strong>Name:</strong> <span id="archive-doctor-name"></span></p>
          <p><strong>Speciality:</strong> <span id="archive-doctor-speciality"></span></p>
        </div>
      </div>
      <div class="modal-actions">
        <button id="archive-confirm-btn" class="btn btn-danger">Yes, Archive Doctor</button>
  ...
  <div id="successModal" class="modal">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h2>Doctor Successfully Archived</h2>
      </div>
      <div class="modal-body">
        <p>The doctor record has been successfully moved to the archive. You can restore it at any time from the archived doctors section.</p>
        <div class="modal-info">
          <p><strong>Doctor ID:</strong> <span id="success-doctor-id"></span></p>
          <p><strong>Name:</strong> <span id="success-doctor-name"></span></p>
          <p><strong>Speciality:</strong> <span id="success-doctor-speciality"></span></p>
        ...
        <div class="modal-note">
          ...
          The doctor's records and history have been preserved and can be accessed from the archived section.
        </div>
      </div>
      <div class="modal-actions">
        <button id="success-ok-btn" class="btn btn-primary">Back to Doctor List</button>
  ...
  <script src="../ajax/admin_searchD.js"></script>
</body>
</html>
