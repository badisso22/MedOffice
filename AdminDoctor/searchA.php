...
<body>
  ...
  <div id="archiveModal" class="modal">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure you want to archive this assistant? This action will move the assistant record to the archive section.</p>
        <div class="modal-info">
          <p><strong>Assistant ID:</strong> <span id="archive-assistant-id"></span></p>
          <p><strong>Name:</strong> <span id="archive-assistant-name"></span></p>
          <p><strong>Age:</strong> <span id="archive-assistant-age"></span></p>
        </div>
      </div>
      <div class="modal-actions">
        <button onclick="confirmArchive()" class="btn btn-danger">Yes, Archive Assistant</button>
  ...
  <div id="successModal" class="modal">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>The assistant record has been successfully moved to the archive. You can restore it at any time from the archived assistants section.</p>
        <div class="modal-info">
          <p><strong>Assistant ID:</strong> <span id="success-assistant-id"></span></p>
          <p><strong>Name:</strong> <span id="success-assistant-name"></span></p>
          <p><strong>Age:</strong> <span id="success-assistant-age"></span></p>
        ...
        <div class="modal-note">
          ...
          The assistant's records and history have been preserved and can be accessed from the archived section.
        </div>
      </div>
      <div class="modal-actions">
        <button onclick="window.location.href='searchA.php'" class="btn btn-primary">Back to Assistant List</button>
  ...
  <script src="../ajax/admin_searchA.js"></script>
</body>
</html>
