...
<body>
  ...
  </div>  <div id="unarchiveModal" class="modal">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-info">
          <p><strong>Patient ID:</strong> 002</p>
          <p><strong>Name:</strong> John Wilson</p>
          <p><strong>Age:</strong> 45</p>
        </div>
      </div>
      <div class="modal-actions">
        <button onclick="confirmUnarchive()" class="btn btn-primary">Yes, Unarchive Patient</button>
