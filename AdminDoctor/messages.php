    ...
    <nav>
        <div class="nav-container">
            ...
            <div class="nav-cta">
                ...
                <a href="dashboard_ad.php" class="nav-icon active" title="Messages">
                    <svg viewBox="0 0 24 24" width="24" height="24"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
                </a>
