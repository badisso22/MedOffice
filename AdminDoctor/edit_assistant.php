...
<head>
    ...
    <title>Edit Assistant - MedOffice</title>
...
<body>
    ...
    <div class="edit-wrapper">
        ...
        <form class="edit-form" id="assistantEditForm">
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="experience" name="experience" class="form-input" min="0" step="0.1" />
                    </div>
    ...
    <script src="../ajax/edit_assistant.js"></script>
    <script>
