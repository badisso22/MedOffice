...
<head>
    ...
    <title>Report Analytics - MedOffice</title>
...
<body>  
        ...
        <div class="page-container">
            <div class="page-header">
                ...
                <div class="header-actions">
                    <select class="time-period-select" id="timePeriod" onchange="loadReports()">
            ...
            <div class="metrics-grid">
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        ...
                        <div class="metric-change positive" id="patients-change">
                            <span>Loading...</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        ...
                        <div class="metric-change positive" id="appointments-change">
                            <span>Loading...</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        ...
                        <div class="metric-value" id="completed-consultations">—</div>
                        <div class="metric-change positive" id="consultations-change">
                            <span>Loading...</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="demographics-grid">
                <div class="card demographics-card">
                    ...
                    <div class="demographics-list" id="age-distribution">
                ...
                <div class="card demographics-card">
                    ...
                    <div class="demographics-list" id="appointment-types">
                        <p style="text-align: center; color: #6b7280;">Loading...</p>
                    </div>
                </div>
            </div>
    ...
    <script src="../ajax/admin-reports.js"></script>
    <script>
