...
try {
    ...
    $sql = "SELECT cabinetname, cabinetlocation, contact_email, cabinetphonenumber, cabinetworktime, cabinetspeciality, cabinetbio FROM CabinetInfo WHERE cabinetID = ? LIMIT 1";
