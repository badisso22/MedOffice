...
try {
    ...
    if (!$patientID || !$consultationType || !$consultationDate || !$symptoms || !$diagnosis || !$treatmentPlan || !$additionalNotes) {
    ...
    $stmt->bind_param('isssssssd', $patientID, $consultationDate, $consultationType, $symptoms, $diagnosis, $treatmentPlan, $additionalNotes, $nextAppointment, $medicalFees);
    $stmt->execute();
