...
<div class="modal-overlay" id="modalOverlay">
  <div class="modal">
    ...
    <div class="modal-body">
      <form id="appointmentForm" onsubmit="event.preventDefault(); searchAvailableCabinets();">
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn-modal btn-modal-primary" id="findCabinetsBtn" onclick="searchAvailableCabinets()">Find Available Cabinets</button>
    </div>
  </div>
</div>
<div class="modal-overlay" id="cabinetModalOverlay">
  <div class="modal modal-large">
    <div class="modal-header">
      <h3>Select Your Cabinet</h3>
      <button class="modal-close" onclick="closeCabinetModal()">×</button>
    </div>
    <div class="modal-body">
    ...
    <div class="modal-footer">
      <button class="btn-modal btn-modal-secondary" onclick="backToAppointmentForm()">← Back</button>
    </div>
  </div>
</div>
...
<script src="../JS/calendarP.js"></script>
</body>
</html>