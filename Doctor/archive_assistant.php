...
<head>
  ...
  <title>Assistant Archive - MedOffice</title>
...
<body>
        ...
        <tr>
          ...
          <td>
            <div class="action-buttons">
              <a href="view-assistant.php?id=003" class="action-btn view-btn" title="View">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                  <circle cx="12" cy="12" r="3"></circle>
                </svg>
              </a>
              <a href="javascript:void(0);" onclick="openUnarchiveModal('003', 'Maria Garcia', '32')" class="action-btn unarchive-btn" title="Unarchive">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <div id="unarchiveModal" class="modal-overlay">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h2>Unarchive Assistant</h2>
      </div>

      <div class="modal-body">
        <p class="modal-message">
          Are you sure you want to unarchive this assistant? This action will restore the assistant record to the active list.
        </p>

        <div class="modal-assistant-info">
          <p><strong>Assistant ID:</strong> <span id="modalAssistantId"></span></p>
          <p><strong>Name:</strong> <span id="modalAssistantName"></span></p>
          <p><strong>Age:</strong> <span id="modalAssistantAge"></span></p>
        </div>

        <div class="modal-actions">
          <button onclick="confirmUnarchive()" class="modal-btn modal-btn-danger">Yes, Unarchive Assistant</button>
          <button onclick="closeUnarchiveModal()" class="modal-btn modal-btn-cancel">Cancel</button>
        </div>
      </div>
    </div>
  </div>
  <div id="successModal" class="modal-overlay">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h2>Assistant Successfully Unarchived</h2>
      </div>

      <div class="modal-body">
        <p class="modal-message">
          The assistant has been successfully unarchived and restored to the active assistant list.
        </p>

        <div class="archived-assistant-info">
          <p><strong>Assistant ID:</strong> <span id="successAssistantId"></span></p>
          <p><strong>Name:</strong> <span id="successAssistantName"></span></p>
          <p><strong>Age:</strong> <span id="successAssistantAge"></span></p>
          <p><strong>Status:</strong> <span style="color: #16a34a; font-weight: 600;">Active</span></p>
        </div>

        <div class="info-box">
          <p>📋 The assistant is now available in your active assistant list</p>
        </div>

        <div class="action-buttons-success">
          <a href="searchA.php" class="btn-large btn-primary">Back to Assistant List</a>
          <a href="dashboard_d.php" class="btn-large btn-secondary">Go to Dashboard</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="../JS/archive_assistant.js"></script>
  <script>
