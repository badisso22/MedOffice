...
<head>
  ...
  <title>Assistant's List - MedOffice</title>
...
<body>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="modal-message">
          Are you sure you want to archive this assistant? This action will move the assistant record to the archive section.
        </p>
        <div class="modal-assistant-info" id="assistantInfo">
          <p><strong>Assistant ID:</strong> <span id="modalAssistantId">001</span></p>
          <p><strong>Name:</strong> <span id="modalAssistantName">kim park</span></p>
          <p><strong>Age:</strong> <span id="modalAssistantAge">25</span></p>
        </div>
        <div class="modal-actions">
          <button class="modal-btn modal-btn-danger" onclick="confirmArchive()">Yes, Archive Assistant</button>
  ...
  <div class="modal-overlay" id="successModal">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h2>Assistant Successfully Archived</h2>
      </div>
      <div class="modal-body">
        <p class="success-message">
          The assistant has been successfully archived and moved to the archived list.
        </p>
        <div class="archived-assistant-info">
          <p><strong>Assistant ID:</strong> <span id="successAssistantId">001</span></p>
          <p><strong>Name:</strong> <span id="successAssistantName">kim park</span></p>
          <p><strong>Age:</strong> <span id="successAssistantAge">25</span></p>
          <p><strong>Status:</strong> <span style="color: #16a34a; font-weight: 600;">Archived</span></p>
        </div>
        <div class="info-box">
          <p>📋 You can restore or view this assistant from the archive at any time</p>
        </div>
        <div class="action-buttons-success">
          <a href="searchA.php" class="btn btn-primary btn-large">Back to Assistant List</a>
          <a href="dashboard_d.php" class="btn btn-secondary btn-large">Go to Dashboard</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <h1>Assistant's List</h1>
    <form>
      <div class="form-group">
        <label for="searchName">Assistant Name</label>
        ...
        <tr>
          ...
          <td>
            <div class="action-buttons">
              <a href="view_assistant.php" class="action-btn view-btn" title="View">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                  <circle cx="12" cy="12" r="3"></circle>
                </svg>
              </a>
              <a href="edit_assistant.php" class="action-btn edit-btn" title="Edit">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                </svg>
              </a>
              <a href="javascript:void(0);" onclick="openArchiveModal('001', 'kim park', '25')" class="action-btn archive-btn" title="Archive">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <script src="../JS/searchA.js"></script>
  <script>
