  ...
  <div class="drawer-overlay" id="drawerOverlay" onclick="toggleDrawer()"></div>
    <main class="dashboard-main">
        <section class="form-hero">
            <div class="hero-badge">Assistant Registration</div>
            <h1>Add New <span class="highlight">Assistant</span></h1>
            <p>Register a new assistant and create their profile</p>
        </section>
        ...
        <section class="form-container">
            <form method="post" class="modern-form">
                ...
                <div class="form-actions">
                    ...
                    <a href="dashboard_d.php" class="btn btn-white btn-large">Cancel</a>
                </div>
            </form>
        </section>
    </main>
