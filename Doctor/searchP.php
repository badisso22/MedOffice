    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="action-buttons-success">
          <a href="searchP.php" class="btn btn-primary btn-large">Back to Patient List</a>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>29</td>
          <td>samia.boulkrinat@gmail.ccom</td>
          ...
          <td>
            <div class="action-buttons">
              ...
              <a href="javascript:void(0);" onclick="openArchiveModal('001', 'Samia Boulkrinat', '29')" class="action-btn archive-btn" title="Archive">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2">
