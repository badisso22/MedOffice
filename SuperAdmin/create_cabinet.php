...
<body>
        ...
        <div id="step1" class="wizard-step active">
            <div class="modal-content" style="position: relative; max-width: 600px; margin: 2rem;">
                <div class="modal-header">
                    ...
                    <p style="color: var(--text-tertiary); font-size: 0.9rem; margin-top: 0.5rem;">Step 1 of 2: Cabinet Information</p>
                </div>
                <div class="modal-body">
                    <form id="cabinetInfoForm">
        ...
        <div id="step2" class="wizard-step">
            <div class="modal-content" style="position: relative; max-width: 600px; margin: 2rem;">
                <div class="modal-header">
                    ...
                    <p style="color: var(--text-tertiary); font-size: 0.9rem; margin-top: 0.5rem;">Step 2 of 2: Administrator Setup</p>
                </div>
                <div class="modal-body">
    ...
    <script>
        ...
        // Step 1: Cabinet Info Form
        document.getElementById('cabinetInfoForm').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            cabinetData = {
                ...
                specialties: document.getElementById('cabinetSpecialties').value,
                capacity: document.getElementById('cabinetCapacity').value,
                description: document.getElementById('cabinetDescription').value
            };

            console.log('[v0] Cabinet data collected:', cabinetData);
        ...
        document.getElementById('adminAccountForm').addEventListener('submit', function(e) {
            ...
            console.log('[v0] Admin data collected:', adminData);
            console.log('[v0] Complete cabinet setup:', { cabinet: cabinetData, admin: adminData });
            ...
            // Simulate API call
            setTimeout(() => {
                document.getElementById('successCabinetName').textContent = cabinetData.name;
                showStep('success');
            }, 2500);
        });
