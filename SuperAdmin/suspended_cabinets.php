...
<head>
    ...
    <title>Suspended Cabinets - Admin Dashboard</title>
...
<body>
    ...
    <main class="main-content">
        <div class="section-header">
            <div>
                <h1>Suspended Cabinets</h1>
                <p>Manage suspended cabinets requiring attention</p>
            </div>
        </div>
        <div class="tabs-container" style="margin-bottom: 2rem;">
            <div class="tabs">
                <a href="cabinets.php" class="tab">Active Cabinets</a>
                <a href="suspended_cabinets.php" class="tab active">Suspended Cabinets</a>
        ...
        <div class="metrics-grid" style="margin-bottom: 2rem;">
            <div class="metric-card">
                ...
                <div class="metric-content">
                    ...
                    <span class="metric-status warning">Needs attention</span>
                </div>
            </div>
            <div class="metric-card">
                <div class="metric-icon">
                ...
                <div class="metric-content">
                    ...
                    <span class="metric-status">Awaiting action</span>
                </div>
            </div>
            <div class="metric-card">
                <div class="metric-icon">
                ...
                <div class="metric-content">
                    ...
                    <span class="metric-status positive">Can be unsuspended</span>
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="action-btn" onclick="window.location.href='view_cabinet.php?id=4'">View</button>
                                <button class="action-btn edit" onclick="editCabinet(4, 'CAB-004', 'Building B - Floor 3', 'Compact', '15')">Edit</button>
                                <button class="action-btn suspend" onclick="unsuspendCabinet(4, 'CAB-004')">Unsuspend</button>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>CAB-007</td>
                        <td>Building C - Floor 2</td>
                        <td>Standard</td>
                        <td>5/30</td>
                        <td>1 week ago</td>
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="action-btn" onclick="window.location.href='view_cabinet.php?id=7'">View</button>
                                <button class="action-btn edit" onclick="editCabinet(7, 'CAB-007', 'Building C - Floor 2', 'Standard', '30')">Edit</button>
                                <button class="action-btn suspend" onclick="unsuspendCabinet(7, 'CAB-007')">Unsuspend</button>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>CAB-012</td>
                        <td>Building D - Entrance</td>
                        <td>Premium</td>
                        <td>0/25</td>
                        <td>3 days ago</td>
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="action-btn" onclick="window.location.href='view_cabinet.php?id=12'">View</button>
                                <button class="action-btn edit" onclick="editCabinet(12, 'CAB-012', 'Building D - Entrance', 'Premium', '25')">Edit</button>
                                <button class="action-btn suspend" onclick="unsuspendCabinet(12, 'CAB-012')">Unsuspend</button>
                            </div>
                        </td>
                    </tr>
                </tbody>
    ...
    <div id="viewCabinetModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Status</label>
                    <p><span class="badge suspended">Suspended</span></p>
                </div>
    ...
    <div id="unsuspendCabinetModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2>Unsuspend Cabinet</h2>
                <button class="modal-close" onclick="closeModal('unsuspendCabinetModal')">&times;</button>
            </div>
            <div class="modal-body">
                <p>Are you sure you want to unsuspend cabinet <strong id="unsuspendCabinetId"></strong>?</p>
                ...
                <input type="hidden" id="unsuspendCabinetDbId">
                <div class="form-group" style="margin-top: 1.5rem;">
                    <label for="unsuspendNotes">Resolution notes</label>
                    <textarea id="unsuspendNotes" rows="3" placeholder="Enter notes about the resolution..."></textarea>
                </div>
                <div class="modal-actions">
                    <button type="button" class="btn-secondary" onclick="closeModal('unsuspendCabinetModal')">Cancel</button>
                    <button type="button" class="btn-success" onclick="handleUnsuspendCabinet()">Unsuspend Cabinet</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../JS/superadmin_suspended_cabinets.js"></script>
</body>
</html>
