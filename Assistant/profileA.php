...
<body>
  <div class="profile-wrapper">
    <div class="profile-header">
      <h1 class="profile-title">Assistant Profile</h1>
    </div>
    <div class="profile-card">
      ...
      <div class="profile-section">
        ...
        <div class="section-content">
          <div class="info-row">
            <span class="info-label">Assistant ID:</span>
            <span class="info-value">1</span>
          </div>
          <div class="info-row">
            <span class="info-label">Full Name:</span>
            <span class="info-value">Kim Park</span>
          </div>
          <div class="info-row">
            <span class="info-label">Email:</span>
            <span class="info-value">kim.park@medic-office.com</span>
          </div>
          <div class="info-row">
            <span class="info-label">Phone:</span>
            <span class="info-value">+1 (888) 888-8889</span>
          </div>
          <div class="info-row">
            <span class="info-label">Address:</span>
            <span class="info-value">Algiers, Cheraga</span>
          </div>
        </div>
      </div>
      <div class="profile-section">
        ...
        <div class="section-content">
          <div class="info-row">
            ...
            <span class="info-value">KimP</span>
          </div>
          <div class="info-row">
      ...
      <div class="profile-actions">
        <a href="dashboard_a.php" class="btn btn-secondary">
