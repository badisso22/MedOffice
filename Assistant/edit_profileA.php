...
<body>
  <div class="profile-wrapper">
    <div class="profile-header">
      <h1 class="profile-title">Edit Assistant Profile</h1>
    </div>
        ...
        <div class="profile-section">
          ...
          <div class="section-content">
            <div class="info-row" style="flex-direction: column; align-items: stretch;">
              ...
              <input type="text" id="fullname" name="fullname" class="form-input" value="Kim Park" required />
            </div>
            <div class="info-row" style="flex-direction: column; align-items: stretch;">
              <label class="info-label" for="email">Email:</label>
              <input type="email" id="email" name="email" class="form-input" value="kim.park@medic-office.com" required />
            </div>
            <div class="info-row" style="flex-direction: column; align-items: stretch;">
              <label class="info-label" for="phone">Phone:</label>
              <input type="tel" id="phone" name="phone" class="form-input" value="8888888889" required pattern="[0-9]{10}" />
            </div>
            <div class="info-row" style="flex-direction: column; align-items: stretch;">
              <label class="info-label" for="address">Address:</label>
              <input type="text" id="address" name="address" class="form-input" value="Algiers, Cheraga" required />
            </div>
          </div>
        </div>
        ...
        <div class="profile-section">
          ...
          <div class="section-content">
            <div class="info-row" style="flex-direction: column; align-items: stretch;">
              ...
              <input type="text" id="username" name="username" class="form-input" value="KimP" required minlength="3" />
            </div>
          </div>
        </div>
